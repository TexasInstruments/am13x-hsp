...
# Embedded Coder Support Package for Texas Instruments AM13x Microcontroller

This repository contains TI's Embedded Coder Support Package for AM13x Microcontroller, enabling Model-Based Design workflows for real-time control applications.
